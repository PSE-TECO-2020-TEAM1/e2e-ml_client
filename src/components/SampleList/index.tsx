import { Button, Heading, Table, Small, majorScale, Tooltip, IconButton, TrashIcon, Pane, Badge } from 'evergreen-ui';
...
const SampleList = ({ collectDataHref, onSampleDelete, samplesPH }: SampleListProps) => <>
    <Table display="flex" flexDirection="column">
        <Table.Head height={majorScale(6)}>
            ...
            <Table.TextHeaderCell flex={0} flexBasis={majorScale(18)}>Label</Table.TextHeaderCell>
