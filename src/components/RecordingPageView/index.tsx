...
import { Button, Heading, Label, majorScale, Pane, Paragraph, Small, Text, Link as EvergreenLink } from 'evergreen-ui';
...
const RecordingPageView = ({ data, format, label, sensorsPH, countdown, remaining, isRecording, isPre, onSend, canSend, reconfigureLink, onRestart, error }: RecordingPageViewProps) => {
